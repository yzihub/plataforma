...
export async function GET() {
  try {
    ...
    const { data: contracts, error: contractsError } = await supabase
      .from("contracts")
      .select("id, tenant_id, lead_id, broker_id, lead_name, project_id, imovel_id, project_name, corretor_name, title, type, status, value, signed_at, expires_at, created_at, updated_at")

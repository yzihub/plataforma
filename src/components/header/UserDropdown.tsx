...
export default function UserDropdown() {
  ...
  return (
    <div className="relative">
      ...
      >
        {/* Avatar */}
        <span className="flex items-center justify-center overflow-hidden rounded-full h-11 w-11 bg-brand-100 dark:bg-brand-900 text-brand-600 dark:text-brand-300 font-semibold text-sm select-none">
          {user?.initials ?? "…"}
        </span>
      ...
      >
        ...
        <div className="flex items-center gap-3 pb-3 border-b border-gray-200 dark:border-gray-800">
          <span className="flex items-center justify-center rounded-full h-10 w-10 bg-brand-100 dark:bg-brand-900 text-brand-600 dark:text-brand-300 font-semibold text-sm select-none shrink-0">
            {user?.initials ?? "…"}
          </span>
          <div className="min-w-0">
            ...
            {isGlobalAdmin && (
              <span className="inline-block mt-0.5 rounded bg-amber-100 dark:bg-amber-500/15 px-1.5 py-px text-[10px] font-semibold text-amber-600 dark:text-amber-400 uppercase tracking-wide">
                Admin
              </span>
            )}
          </div>
        ...
        <form action={signOut}>
          <button
            type="submit"
            className="flex w-full items-center gap-3 px-3 py-2 mt-1 font-medium text-gray-700 rounded-lg group text-theme-sm hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-300"
          >
